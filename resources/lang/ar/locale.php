...
return [
    ...
    //Localization for application exception
        'exceptions' => [
                'general'                  => 'استثناء الخادم',
                'unauthorized'             => 'الإجراء غير مسموح به',
                'invalid_action'           => 'عمل غير صالح. حاول مرة اخرى.',
                'something_went_wrong'     => 'حدث خطأ ما. حاول مرة اخرى',
                'upload_disable_demo_mode' => 'تم تعطيل تحميل الملف في الوضع التجريبي.',
                'alid_image '              => ' صورة غير صالحة. الرجاء تحديث واحد صحيح. ',
                'registration_disabled'    => 'التسجيل معطل.',
                'user_verification'        => 'تم تعطيل التحقق من المستخدم.',
                'invalid_sms_type'         => 'الرجاء إدخال أنواع الرسائل القصيرة الصالحة التي تسمى عادي, و Unicode, و Voice, و MMS, و WhatsApp.',
        ],
    ...
    //Localization for application labels
        'labels'     => [
                ...
                'able_to_revert'                        => 'لن تتمكن من التراجع عن هذا!',
                'delete_it'                             => 'نعم, احذفها!',
                'cancel_it'                             => 'نعم, قم بإلغائها!',
                'enable_selected'                       => 'نعم, تم تمكين المحدد!',
                'disable_selected'                      => 'نعم, قم بتعطيل المحدد!',
                'delete_selected'                       => 'نعم, احذف المحدد!',
                'cancel_selected'                       => 'نعم, إلغاء المحدد!',
                'release_selected'                      => 'نعم, تم تحديد الإصدار!',
                'delete_action_cancelled'               => 'حذف الإجراء الذي ألغيته :)',
                'enable_action_cancelled'               => 'تمكين الإجراء الذي ألغيته :)',
                'disable_action_cancelled'              => 'تعطيل الإجراء الذي ألغته :)',
                'data_not_deleted'                      => 'لم يتم حذف البيانات. حاول مرة اخرى!',
                'at_least_one_data'                     => 'الرجاء تحديد بيانات واحدة على الأقل.',
                ...
                'next_schedule_time'                    => "وقت الجدول التالي",
                ...
                "mms"                                   => "MMS",
                "unit"                                  => "وحدة",
                'using_limits'                          => 'استخدام: استخدام: المتبقي',
                'two_way'                               => 'Two Way',
                'whatsapp'                              => 'WhatsAPP',
                "percentage"                            => "النسبة المئوية",
                'digit'                                 => 'Digit',
                'success_keyword'                       => 'كلمات النجاح',
                'http_request_method'                   => 'أسلوب طلب HTTP',
                'json_encoded_post'                     => "تمكين المنشور المشفر json",
                'content_type'                          => 'نوع المحتوى',
                'content_type_accept'                   => "قبول نوع المحتوى",
                "none"                                  => "لا شيء",
                ...
                'custom'                                => 'Custom',
                "currency"                              => "العملة",
                'display_month_number'                  => ': عدد الأشهر',
                'display_day_number'                    => ': عدد الأيام',
                'display_year_number'                   => ': عدد السنوات',
                'display_week_number'                   => ': عدد الأسابيع',
                'dec_point'                             => '.',
                'thousands_sep'                         => ',',
                "unlimited"                             => "غير محدود",
                "coverage"                              => "التغطية",
                ...
                'get_started_with_numbers'              => 'ابدأ بالأرقام',
                'get_started_with_senderid'             => 'ابدأ مع معرف المرسل',
                'get_started_with_message'              => 'ابدأ برسالة',
                'send_message_to_your_user'             => 'أرسل رسالة مخصصة',
                'numbers_message'                       => 'إدارة الأرقام المحلية',
                'sender_id_message'                     => "إدارة العلامة التجارية بمعرف المرسل",
                'subtotal'                              => 'المجموع الفرعي',
                "preferences"                           => "التفضيلات",
                "api"                                   => "API",
                'switch_view'                           => "تبديل العرض",
                'credits_used'                          => 'الائتمانات المستخدمة',
                "used"                                  => "مستعملة",
                'remaining'                             => 'المتبقية',
                "revenue_this_month"                    => "الإيرادات هذا الشهر",
                "customers_growth"                      => "نمو العملاء",
                'recent_sender_id_requests'             => "طلبات معرف المرسل الأخيرة",
                'sms_reports'                           => 'تقارير SMS',
                "revenue"                               => "الإيرادات",
                'outgoing_sms_history_of_current_month' => 'تاريخ الرسائل القصيرة الصادرة للشهر الحالي',
                'incoming_sms_history_of_current_month' => 'تاريخ الرسائل القصيرة الواردة للشهر الحالي',
                'is_popular'                            => 'هل تريد تحديده كمشهور؟',
                ...
                "bar"                                   => "بار",
                'listed_by'                             => 'مُدرج بواسطة',
                "admins"                                => "المسؤولون",
                "loading"                               => "تحميل",
                "read"                                  => "قراءة",
                "settings"                              => "الإعدادات",
                "originator"                            => "المنشئ",
                'shared_number'                         => "رقم مشترك",
                'unsubscribe'                           => 'إلغاء الاشتراك',
                'subscribe'                             => 'اشتراك',
                "tag"                                   => "علامة",
                "birth_date"                            => "عيد ميلاد",
                "anniversary_date"                      => "الذكرى السنوية",
                'import_file'                           => 'استيراد ملف',
                'paste_text'                            => 'لصق النص',
                "manual_input"                          => "إدخال يدوي",
                'choose_delimiter'                      => 'اختر محددًا',
                'choose_your_option'                    => 'اختر خيارك',
                'sample_file'                           => 'نموذج ملف',
                'download_sample_file'                  => "تنزيل نموذج للملف",
                'total_number_of_recipients'            => 'إجمالي عدد المستلمين',
                'invalid_delimiter'                     => 'محدد غير صالح',
                'message_form'                          => 'نموذج الرسالة',
                'available_tag'                         => "العلامات المتوفرة",
                'subscribe_url'                         => 'عنوان URL للاشتراك',
                "release"                               => "إطلاق",
                'per'                                   => 'Per',
                "every"                                 => "كل",
                "buy"                                   => "شراء",
                "active_numbers"                        => "أرقام نشطة",
                'request_for_new_one'                   => 'طلب واحدة جديدة',
                'create_plan'                           => 'إنشاء خطة',
                'plan_name'                             => "اسم الخطة",
                "free"                                  => "مجاني",
                'payment_required'                      => "الدفع مطلوب",
                "pay"                                   => "دفع",
                'sms_credit'                            => 'وحدة الرسائل القصيرة',
                'whatsapp_credit'                       => "رصيد WhatsApp",
                'cutting_system_available'              => "نظام القطع متاح",
                'api_access'                            => "الوصول إلى واجهة برمجة التطبيقات",
                "text_messages"                         => "الرسائل النصية",
                "voice_messages"                        => "الرسائل الصوتية",
                'picture_messages'                      => "رسائل مصورة",
                'subscribe_now'                         => 'اشترك الآن',
                'credit_per_sms'                        => 'الائتمان لكل رسالة قصيرة',
                'advanced'                              => 'متقدم',
                "one_time"                              => "مرة واحدة",
                "frequency"                             => "التردد",
                'remove_duplicate'                      => 'إزالة النسخة المكررة',
                ...
                "recurring"                             => "متكرر",
                "sending"                               => "إرسال",
                'sms_send'                              => 'SMS المرسلة',
                "campaigns_send"                        => "الحملات المرسلة",
                "processing"                            => "معالجة",
                'run_at'                                => 'الجري في',
                'scheduled'                             => 'مجدولة',
                "paused"                                => "متوقف مؤقتًا",
                'delivered_at'                          => 'تم التسليم عند',
                'checkout'                              => 'الدفع',
                ...
                "payment_information"                   => "ها هي معلومات الدفع الخاصة بك",
                'paid_by'                               => 'مدفوع بواسطة',
                'transaction_id'                        => 'معرف المعاملة',
                "purchase"                              => "شراء",
                'notify_me_by'                          => 'أبلغني بـ',
                "credit_warning"                        => "تحذير ائتماني",
                'subscription_warning'                  => 'تحذير الاشتراك',
                "new_conversion"                        => "تحويل جديد",
                'welcome_to'                            => 'مرحبًا بك في',
                'welcome_to_docs'                       => "مرحبًا بك في: مستندات اسم العلامة التجارية",
                "submitted"                             => "تم الإرسال",
                'finished'                              => 'Finished',
                'greeting_message'                      => ':time :name',
                "good_morning"                          => "صباح الخير",
                "good_noon"                             => "مساء الخير",
                "good_evening"                          => "مساء الخير",
                "good_night"                            => "تصبحون على خير",

                'read_all_notifications'     => 'قراءة جميع الإخطارات',
                'you_have_new_user'          => 'لديك مستخدم جديد',
                'you_have_new_subscription'  => 'لديك اشتراك جديد',
                'new_sender_id_notification' => "إشعار معرف المرسل الجديد",
    ...
    */
        ...
        'menu' => [
                ...
                "Currencies"         => "العملات",
                "Sending"            => "إرسال",
                "Sending Servers"    => "إرسال الخوادم",
                "Keywords"           => "الكلمات الرئيسية",
                "Templates"          => "قوالب",
                "Template Tags"      => "علامات القوالب",
                "Security"           => "الأمان",
                "Sender ID"          => "معرف المرسل",
                "Phone Numbers"      => "أرقام الهواتف",
                "Numbers"            => "أرقام",
                "Blacklist"          => "القائمة السوداء",
                "Spam Word"          => "كلمة غير مرغوب فيها",
                "Ticket"             => "تذكرة",
                "Tickets"            => "تذاكر",
                "Department"         => "القسم",
                "Ad Manager"         => "المسؤول",
                ...
                "Send using File"    => "أرسل باستخدام ملف",
                "Developers"         => "المطورون",
