...
@section('content')
    ...
    <section class="modern-horizontal-wizard">
        <form action="{{route('customer.keywords.pay', $keyword->uid)}}" method="post">
            @csrf
                ...
                <div class="bs-stepper-header">
                    ...
                    <div class="step" data-target="#cart" role="tab" id="cart-trigger">
                        ...
                        <span class="bs-stepper-box">
                            ...
                            <span class="bs-stepper-subtitle">{{ __('locale.keywords.buy_keyword') }} </span>
                        </span>
                        </button>
                    </div>
                    <div class="line">
                ...
                <div class="bs-stepper-content">
                    ...
                    <div id="cart" class="content" role="tabpanel" aria-labelledby="cart-trigger">
                        <div class="content-header">
                            <h5 class="mb-0">{{ __('locale.keywords.buy_keyword') }}</h5>
                            <small>{{ __('locale.keywords.buy_keyword') }} {{ $keyword->keyword_name }}</small>
                        </div>
                        <div class="row mt-1 mb-1">

                            <h5>{{ __('locale.keywords.payment_for_keyword') }}: <span class="text-primary">{{ $keyword->keyword_name }}</span></h5>
                            <h5>{{ __('locale.labels.frequency') }}: <span class="text-primary">{{ $keyword->displayFrequencyTime() }}</span></h5>
                            <h5>{{ __('locale.plans.price') }}: <span class="text-primary"> {{ \App\Library\Tool::format_price($keyword->price, $keyword->currency->format) }} </span></h5>
                        </div>
