<div class="text-uppercase text-primary font-medium-2 mb-3">{{ __('locale.developers.mms_api') }}</div>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td>string</td>
            <td>The type of the message. For text message you have to insert <code>mms</code> as sms type.</td>
        </tr>
...
curl -X POST {{ route('api.sms.send') }} \
     ...
     -d "type=mms" \
     -d "media_url=https://via.placeholder.com/150.jpg" \
