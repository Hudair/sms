        ...
        <div class="action-btns d-none">
            <div class="btn-dropdown mr-1 mb-1 add-new-div">
                ...
                @if(Auth::user()->customer->getOption('list_export') == 'yes')
                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{ route('customer.reports.export.all') }}" class="btn btn-white px-1 py-1 waves-effect waves-light text-info text-bold-500"> {{__('locale.buttons.export')}} <i class="feather icon-file-text"></i></a>
                    </div>
                @endif
