                ...
                <div class="bs-stepper-header">
                    ...
                    <div class="step" data-target="#cart" role="tab" id="cart-trigger">
                        ...
                        <span class="bs-stepper-box">
                            ...
                            <span class="bs-stepper-subtitle">{{ $subscription->plan->name }} {{ __('locale.menu.Plan') }}</span>
                        </span>
                        </button>
                    </div>
                    <div class="line">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td> {{ \App\Library\Tool::format_price($subscription->plan->price, $subscription->plan->currency->format) }} </td>
                                    </tr>

                                    <tr>
                                        <td> {{ __('locale.labels.renew') }} </td>
                                        <td> {{ __('locale.labels.every') }} {{ $subscription->plan->displayFrequencyTime() }} </td>
                                    </tr>
