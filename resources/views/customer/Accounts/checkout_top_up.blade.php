...
@endsection
@section('content')
    <form action="{{ route('user.account.pay') }}" class="icons-tab-steps checkout-tab-steps wizard-circle" method="post">
    @csrf
                ...
                <div class="checkout-items">
                    <div class="card ecommerce-card">
                        <div class="card-content product-description">
                            <div class="card-body">
                                <div class="item-name">
                                    <p>{{ __('locale.labels.add_unit')  }}: <span class="text-primary">{{ $request->add_unit }}</span></p>
                                    <p class="stock-status-in">{{ __('locale.plans.price') }} {{ Auth::user()->customer->subscription->plan->getOption('per_unit_price') * $request->add_unit}} {{ Auth::user()->customer->subscription->plan->currency->code}} </p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="detail">
                                    ...
                                    <div class="detail-amt">
                                        {{ Auth::user()->customer->subscription->plan->getOption('per_unit_price') * $request->add_unit}} {{ Auth::user()->customer->subscription->plan->currency->code}}
                                    </div>
                                </div>
                                <div class="detail">
                                    <div class="detail-title">
                                ...
                                <div class="detail">
                                    ...
                                    <div class="detail-amt total-amt">{{ Auth::user()->customer->subscription->plan->getOption('per_unit_price') * $request->add_unit}} {{ Auth::user()->customer->subscription->plan->currency->code}}</div>
                                </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="detail">
                                    ...
                                    <div class="detail-amt">
                                        <strong>{{ Auth::user()->customer->subscription->plan->getOption('per_unit_price') * $request->add_unit}} {{ Auth::user()->customer->subscription->plan->currency->code}}</strong>
                                    </div>
                                </div>
                                <div class="detail">
                                    <div class="details-title">
