...
@section('content')
    ...
    <section id="datatables-basic">
        <div class="mb-3 mt-2">
            ...
            @can('create_sending_servers')
                <div class="btn-group">
                    <a href="{{route('customer.sending-servers.select')}}" class="btn btn-success waves-light waves-effect fw-bold mx-1"> {{__('locale.buttons.new_server')}} <i data-feather="plus-circle"></i></a>
                </div>
            @endcan
