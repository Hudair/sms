    ...
    <section id="datatables-basic">
        <div class="mb-3 mt-2">
            ...
            @can('create_blacklist')
                <div class="btn-group">
                    <a href="{{route('customer.blacklists.create')}}" class="btn btn-success waves-light waves-effect fw-bold mx-1"> {{__('locale.buttons.add_new')}} <i data-feather="plus-circle"></i></a>
                </div>
            @endcan
