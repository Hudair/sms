                ...
                <div class="bs-stepper-content">
                    ...
                    <div id="cart" class="content" role="tabpanel" aria-labelledby="cart-trigger">
                        ...
                        <div class="row mt-1 mb-1">
                            ...
                            <h5>{{ __('locale.sender_id.payment_for_sender_id') }}: <span class="text-primary">{{ $senderid->sender_id }}</span></h5>
                            <h5>{{ __('locale.labels.frequency') }}: <span class="text-primary">{{ $senderid->displayFrequencyTime() }}</span></h5>
                            <h5>{{ __('locale.plans.price') }}: <span class="text-primary"> {{ \App\Library\Tool::format_price($senderid->price, $senderid->currency->format) }} </span></h5>
                        </div>
