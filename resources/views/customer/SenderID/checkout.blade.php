...
@endsection
@section('content')
    <form action="{{route('customer.senderid.pay', $senderid->uid)}}" class="icons-tab-steps checkout-tab-steps wizard-circle" method="post">
    @csrf
                ...
                <div class="checkout-items">
                    <div class="card ecommerce-card">
                        <div class="card-content product-description">
                            <div class="card-body">
                                <div class="item-name">
                                    <p>{{ __('locale.sender_id.payment_for_sender_id') }}: <span class="text-primary">{{ $senderid->sender_id }}</span></p>
                                    <p>{{ __('locale.labels.frequency') }}: <span class="text-primary">{{ $senderid->displayFrequencyTime() }}</span></p>
                                    <p class="stock-status-in">{{ __('locale.plans.price') }} {{ \App\Library\Tool::format_price($senderid->price, $senderid->currency->format) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="detail">
                                    ...
                                    <div class="detail-amt">
                                        {{ \App\Library\Tool::format_price($senderid->price, $senderid->currency->format) }}
                                    </div>
                                </div>
                                <div class="detail">
                                    <div class="detail-title">
                                ...
                                <div class="detail">
                                    ...
                                    <div class="detail-amt total-amt">{{ \App\Library\Tool::format_price($senderid->price, $senderid->currency->format) }}</div>
                                </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="detail">
                                    ...
                                    <div class="detail-amt">
                                        <strong>{{ \App\Library\Tool::format_price($senderid->price, $senderid->currency->format) }}</strong>
                                    </div>
                                </div>
                                <div class="detail">
                                    <div class="details-title">
