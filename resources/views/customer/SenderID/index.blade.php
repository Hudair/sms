                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full) {
                            ...
                            if (!full['is_checkout']) {
                                $actions += '<span class="action-delete text-danger cursor-pointer" data-bs-toggle="tooltip" data-placement="top" title=' + full['delete'] + ' data-id=' + full['uid'] + '>' +
                                    feather.icons['trash'].toSvg({class: 'font-medium-4'}) +
                                    '</span>'
                            } else {
                                $actions +=
                                    '<span class="action-delete text-danger cursor-pointer me-1" data-bs-toggle="tooltip" data-placement="top" title=' + full['delete'] + ' data-id=' + full['uid'] + '>' +
                                    feather.icons['trash'].toSvg({class: 'font-medium-4'}) +
                                    '</span>' +
