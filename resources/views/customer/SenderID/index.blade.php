            ...
            <div class="btn-dropdown mr-1 mb-1 add-new-div">
                ...
                @if($sender_id_plan > 0)
                    @can('create_sender_id')
                        <div class="btn-group dropdown actions-dropodown">
                            <a href="{{route('customer.senderid.request')}}" class="btn btn-white px-1 py-1 waves-effect waves-light text-success text-bold-500"> {{__('locale.labels.request_for_new_one')}} <i class="feather icon-plus-circle"></i></a>
                        </div>
                    @endcan
                @endif
