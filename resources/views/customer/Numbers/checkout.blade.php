...
@section('content')
    ...
    <section class="modern-horizontal-wizard">
        <form action="{{route('customer.numbers.pay', $number->uid)}}" method="post">
            @csrf
                ...
                <div class="bs-stepper-header">
                    ...
                    <div class="step" data-target="#cart" role="tab" id="cart-trigger">
                        ...
                        <span class="bs-stepper-box">
                            ...
                            <span class="bs-stepper-subtitle">{{ __('locale.phone_numbers.buy_number') }} </span>
                        </span>
                        </button>
                    </div>
                    <div class="line">
                ...
                <div class="bs-stepper-content">
                    ...
                    <div id="cart" class="content" role="tabpanel" aria-labelledby="cart-trigger">
                        <div class="content-header">
                            <h5 class="mb-0">{{ __('locale.phone_numbers.buy_number') }}</h5>
                            <small>{{ __('locale.phone_numbers.buy_number') }} {{ $number->number }}</small>
                        </div>
                        <div class="row mt-1 mb-1">

                            <h5>{{ __('locale.phone_numbers.payment_for_number') }}: <span class="text-primary">{{ $number->number }}</span></h5>
                            <h5>{{ __('locale.labels.frequency') }}: <span class="text-primary">{{ $number->displayFrequencyTime() }}</span></h5>
                            <h5>{{ __('locale.plans.price') }}: <span class="text-primary"> {{ \App\Library\Tool::format_price($number->price, $number->currency->format) }} </span></h5>
                        </div>
