        ...
        <div class="action-btns d-none">
            <div class="btn-dropdown mr-1 mb-1 add-new-div">
                ...
                @can('create_contact_group')
                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{ route('customer.contacts.create') }}" class="btn btn-white px-1 py-1 waves-effect waves-light text-success text-bold-500"> {{__('locale.buttons.add_new')}} <i class="feather icon-plus-circle"></i></a>
                    </div>
                @endcan

                @can('view_contact_group')
                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{ route('customer.contacts.export') }}" class="btn btn-white px-1 py-1 waves-effect waves-light text-info text-bold-500"> {{__('locale.buttons.export')}} <i class="feather icon-file-text"></i></a>
                    </div>
                @endcan
        ...
        $(document).ready(function () {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        dataListView.rows('.selected').every(function (rowIdx) {
                            contactGroups.push(dataListView.row(rowIdx).data().uid)
                        })
            ...
            $(".bulk-disable").on('click', function (e) {
                ...
                Swal.fire({
                    ...
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    confirmButtonText: "{{__('locale.labels.disable')}}",
                    confirmButtonClass: 'btn btn-danger',
                    cancelButtonClass: 'btn btn-primary ml-1',
                    buttonsStyling: false,
                }).then(function (result) {
