    ...
    <section id="data-list-view" class="data-list-view-header">
        <div class="action-btns d-none">
            <div class="btn-dropdown mr-1 mb-1 add-new-div">
                ...
                @can('view tags')
                    <div class="btn-group dropdown actions-dropodown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item bulk-required" href="#"><i class="feather icon-check"></i>{{ __('locale.labels.required') }}</a>
                            <a class="dropdown-item bulk-optional" href="#"><i class="feather icon-stop-circle"></i>{{ __('locale.labels.optional') }}</a>
                ...
                @can('create tags')
                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{route('admin.tags.create')}}" class="btn btn-white px-1 py-1 waves-effect waves-light text-success text-bold-500"> {{__('locale.buttons.create')}} <i class="feather icon-plus-circle"></i></a>
                    </div>
                @endcan

                @can('view tags')
                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{route('admin.tags.export')}}" class="btn btn-white px-1 py-1 waves-effect waves-light text-info text-bold-500"> {{__('locale.buttons.export')}} <i class="feather icon-file-text"></i></a>
                    </div>
                @endcan
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        dataListView.rows('.selected').every(function (rowIdx) {
                            template_tags.push(dataListView.row(rowIdx).data().uid)
                        })

                        if (template_tags.length > 1) {
