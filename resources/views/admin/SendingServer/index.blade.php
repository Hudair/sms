        ...
        <div class="action-btns d-none">
            <div class="btn-dropdown mr-1 mb-1 add-new-div">
                ...
                @can('create sending_servers')
                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{route('admin.sending-servers.select')}}" class="btn btn-white px-1 py-1 waves-effect waves-light text-success text-bold-500">{{__('locale.buttons.new_server')}} <i class="feather icon-plus-circle"></i></a>
                    </div>
                @endcan

                @can('view sending_servers')
                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{route('admin.sending-servers.export')}}" class="btn btn-white px-1 py-1 waves-effect waves-light text-info text-bold-500">{{__('locale.buttons.export')}} <i class="feather icon-file-text"></i></a>
                    </div>
                @endcan
