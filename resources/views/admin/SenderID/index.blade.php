        ...
        <div class="action-btns d-none">
            <div class="btn-dropdown mr-1 mb-1 add-new-div">
                ...
                @can('view sender_id')
                    <div class="btn-group dropdown actions-dropodown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item bulk-active" href="#"><i class="feather icon-check"></i>{{ __('locale.labels.active') }}</a>
                            <a class="dropdown-item bulk-block" href="#"><i class="feather icon-stop-circle"></i>{{ __('locale.labels.block') }}</a>
                ...
                @can('create sender_id')
                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{route('admin.senderid.create')}}" class="btn btn-white px-1 py-1 waves-effect waves-light text-success text-bold-500"> {{__('locale.buttons.create')}} <i class="feather icon-plus-circle"></i></a>
                    </div>
                @endcan

                @can('view sender_id')
                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{route('admin.senderid.export')}}" class="btn btn-white px-1 py-1 waves-effect waves-light text-info text-bold-500"> {{__('locale.buttons.export')}} <i class="feather icon-file-text"></i></a>
                    </div>

                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{route('admin.senderid.plan')}}" class="btn btn-white px-1 py-1 waves-effect waves-light text-primary text-bold-500"> {{__('locale.labels.create_plan')}} <i class="feather icon-shopping-cart"></i></a>
                    </div>
                @endcan
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        dataListView.rows('.selected').every(function (rowIdx) {
                            sender_ids.push(dataListView.row(rowIdx).data().uid)
                        })

                        if (sender_ids.length > 1) {
