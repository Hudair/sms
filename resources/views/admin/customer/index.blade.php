    ...
    <section id="data-list-view" class="data-list-view-header">
        <div class="action-btns d-none">
            <div class="btn-dropdown mr-1 mb-1 add-new-div">
                ...
                @can('create customer')
                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{route('admin.customers.create')}}" class="btn btn-white px-1 py-1 waves-effect waves-light text-success text-bold-500"> {{__('locale.buttons.add_new')}} <i class="feather icon-plus-circle"></i></a>
                    </div>
                @endcan

                @can('view customer')
                    <div class="btn-group dropdown actions-dropodown">
                        <a href="{{route('admin.customers.export')}}" class="btn btn-white px-1 py-1 waves-effect waves-light text-info text-bold-500"> {{__('locale.buttons.export')}} <i class="feather icon-file-text"></i></a>
                    </div>
                @endcan
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        dataListView.rows('.selected').every(function (rowIdx) {
                            customer_ids.push(dataListView.row(rowIdx).data().uid)
                        })
