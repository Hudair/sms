                    ...
                    <tr>
                        ...
                        <td>
                            <div class='custom-control custom-switch switch-lg custom-switch-success'>
                                <input type="checkbox" class="custom-control-input get_status" id="{{ $gateway->uid }}" data-id="{{ $gateway->uid }}" name='status' @if($gateway->status == true) checked @endif>
                                <label class="custom-control-label" for="{{ $gateway->uid }}">
                        ...
                        <td>
                            @can('update payment_gateways')
                                <a href="{{ route('admin.payment-gateways.show', $gateway->uid) }}" class='text-primary mr-1'><i class="feather icon-settings"></i> {{__('locale.labels.settings')}}</a>
                            @endcan
                        </td>
                    </tr>
                @endforeach
