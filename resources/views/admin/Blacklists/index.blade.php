    ...
    <section id="datatables-basic">
        <div class="mb-3 mt-2">
            ...
            @can('create blacklist')
                <div class="btn-group">
                    <a href="{{route('admin.blacklists.create')}}" class="btn btn-success waves-light waves-effect fw-bold mx-1"> {{__('locale.buttons.add_new')}} <i data-feather="plus-circle"></i></a>
                </div>
            @endcan

            @can('view blacklist')
                <div class="btn-group">
                    <a href="{{route('admin.blacklists.export')}}" class="btn btn-info waves-light waves-effect fw-bold"> {{__('locale.buttons.export')}} <i data-feather="file-text"></i></a>
                </div>
            @endcan
