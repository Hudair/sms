                            ...
                            <form id="environment_form" style="width: 500px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" id="app_url" class="form-control" name="app_url" value="{{ rtrim(request()->url(), 'update') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" id="database_host" class="form-control" value="{{ config('database.connections.mysql.host') }}" name="database_host" required/>
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="database_name" class="form-control" name="database_name" value="{{ config('database.connections.mysql.database') }}" required/>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="database_user_name" class="form-control" name="database_username" value="{{ config('database.connections.mysql.username') }}" required/>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label class="form-label required" for="database_password">Database Password</label>
                                        <input type="password" id="database_password" class="form-control" name="database_password" value="{{config('database.connections.mysql.password')}}" required/>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="customer" id="customer">
                                                ...
                                                <option value="0" selected>{{ __('locale.labels.inactive')}} </option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
        ...
        $(function () {
            ...
            if (typeof verticalWizard !== undefined && verticalWizard !== null) {
                ...
                $('#environment_form').on('submit', function (e) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: "{{ route('Updater::environmentDatabase') }}",
                ...
                $('#profile_form').on('submit', function (e) {
                    ...
                    toastr.success('It will take few minutes', 'Success!!', {
                        positionClass: 'toast-top-right',
                        containerId: 'toast-top-right',
                        progressBar: true,
                        closeButton: true,
